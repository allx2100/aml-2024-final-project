...
class GlowConvVAE(BaseVAE):
    def __init__(
        ...
        super(GlowConvVAE, self).__init__()
    ...
    def loss_function(self, args):
        recons, input, mu, log_var, z0, zK, log_det_jacobian = args
